      ...
      <header
        className={cn(
          ...
          solid
            ...
            : "border-b border-transparent bg-gradient-to-b from-ink/25 to-transparent",
        )}
      >
            ...
            {navLinks.slice(1).map((link) => (
              <Link
                ...
                className={cn(
                  ...
                  solid ? "text-muted-foreground hover:text-ink" : "text-background/80 hover:text-background",
                )}

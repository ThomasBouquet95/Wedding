...
const fr = {
    ...
    days: [
      {
        ...
        note: "Nous vous attendons dans le parc du Couvent dès votre arrivée, pour commencer le week-end tous ensemble.",
        events: [
          { time: "À partir de 17h", label: "Arrivée et soirée d'accueil dans le parc du Couvent" },
  ...
  covoiturage: {
    ...
    seatsNone: "Complet",
    passengers: "Avec",
    passengerRename: "Corriger ce nom",
    passengerRemove: "Retirer",
    passengerSave: "Enregistrer",
    passengerRemoved: "Passager retiré, sa place est de nouveau libre.",
    passengerRenamed: "Le nom a été corrigé.",
    tripsCount: "trajet proposé",
    tripsCountMany: "trajets proposés",
    colTrip: "Le trajet",
    colWhen: "Quand",
    colContact: "Contacter",
    join: "Je monte",
    joinName: "Votre nom",
    joinConfirm: "Ajouter",
    joined: "C'est noté, vous êtes sur ce trajet.",
    joinFull: "Cette voiture est complète.",
    arrival: "Aller",
    departure: "Retour",
    ...
    fields: {
      ...
      seats: "Places libres à l'aller",
      seatsChoose: "Combien ?",
      seatsReturn: "Places libres au retour",
      comment: "Commentaire",
...
const en: Translated<typeof fr> = {
    ...
    days: [
      {
        ...
        note: "We'll be in the Couvent gardens as you arrive, ready to begin the weekend together.",
        events: [
          { time: "From 5 pm", label: "Arrival and welcome evening in the Couvent gardens" },
  ...
  covoiturage: {
    ...
    seatsNone: "Full",
    passengers: "With",
    passengerRename: "Correct this name",
    passengerRemove: "Remove",
    passengerSave: "Save",
    passengerRemoved: "Passenger removed — their seat is free again.",
    passengerRenamed: "The name has been corrected.",
    tripsCount: "journey posted",
    tripsCountMany: "journeys posted",
    colTrip: "The journey",
    colWhen: "When",
    ...
    joinName: "Your name",
    joinConfirm: "Add",
    joined: "Noted — you're on this journey.",
    joinFull: "This car is full.",
    arrival: "Out",
    departure: "Back",
    ...
    fields: {
      ...
      seats: "Free seats on the way there",
      seatsChoose: "How many?",
      seatsReturn: "Free seats on the way back",
      comment: "Comment",
